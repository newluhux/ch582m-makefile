...
// 支持的最大接口数量
#define USB_INTERFACE_MAX_NUM 3
// 接口号的最大值
#define USB_INTERFACE_MAX_INDEX 2
...
const uint8_t MyCfgDescr[] = {
    0x09, 0x02, 0x52, 0x00, 0x03, 0x01, 0x00, 0xA0, 0x32,  //配置描述符
    ...
    0x09, 0x04, 0x02, 0x00, 0x02, 0xFF, 0xFF, 0xFF, 0x00,  //接口描述符,串口
    0x07, 0x05, 0x83, 0x02, 0x40, 0x00, 0x01,              //端点描述符
    0x07, 0x05, 0x03, 0x02, 0x40, 0x00, 0x01,              //端点描述符
};
/* USB速度匹配描述符 */
const uint8_t My_QueDescr[] = {0x0A, 0x06, 0x00, 0x02, 0xFF,
...
const uint8_t MouseRepDesc[] = {
    ...
    0x09, 0x19, 0x01, 0x29, 0x03, 0x15, 0x00, 0x25, 0x01, 0x75, 0x01,
    0x95, 0x03, 0x81, 0x02, 0x75, 0x05, 0x95, 0x01, 0x81, 0x01, 0x05,
      ...
      if ((pSetupReqPak->bRequestType & USB_REQ_TYP_MASK) !=
        ...
        if (pSetupReqPak->bRequestType & 0x40) {
          ...
          case DEF_USB_SET_PROTOCOL: /* 0x0B: SET_PROTOCOL */ //主机想设置HID设备当前所使用的协议
            Report_Value[pSetupReqPak->wIndex] =
...
void usb_serial_write(uint8_t *buf, int len) {
	...
	memcpy(pEP3_IN_DataBuf, buf, len);
	DevEP3_IN_Deal(len);
}
